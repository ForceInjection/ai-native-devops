...
CloudPilot 云管平台 MVP 是三层框架交汇的具象验证：以 Vibe Coding 为日常工作模式，走通 DevOps 8 阶段（从三方访谈到 OpenSpec 规范），在 P5 实现阶段落地 Architecture 三层模型（报价=Tool、审批=Skill、智能推荐=Agent）。
...
| 资源                                                                                         | 说明                                                                 |
| :------------------------------------------------------------------------------------------- | :------------------------------------------------------------------- |
| `reference/GBT+42560-2023/`                                                                  | GB/T 42560-2023 AI DevOps 能力成熟度模型（提取 Markdown + 原版 PDF） |
